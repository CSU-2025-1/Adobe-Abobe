...
class UploadServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadImage = channel.unary_unary(
                ...
                request_serializer=upload__pb2.ImageUploadRequest.SerializeToString,
                response_deserializer=upload__pb2.ImageUploadResponse.FromString,
...
def add_UploadServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UploadImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=upload__pb2.ImageUploadRequest.FromString,
                    response_serializer=upload__pb2.ImageUploadResponse.SerializeToString,
            ),
    }
...
class UploadService(object):
    ...
    def UploadImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/upload.UploadService/UploadImage',
            upload__pb2.ImageUploadRequest.SerializeToString,
            upload__pb2.ImageUploadResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

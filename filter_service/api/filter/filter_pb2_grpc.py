...
import api.filter.filter_pb2 as filter__pb2
...
class FilterServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ApplyFilters = channel.unary_unary(
                '/api.filter.FilterService/ApplyFilters',
                request_serializer=filter__pb2.FilterRequest.SerializeToString,
                response_deserializer=filter__pb2.FilterResponse.FromString,
...
def add_FilterServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ApplyFilters': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=filter__pb2.FilterResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'api.filter.FilterService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('api.filter.FilterService', rpc_method_handlers)
...
class FilterService(object):
    ...
    def ApplyFilters(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            filter__pb2.FilterResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
